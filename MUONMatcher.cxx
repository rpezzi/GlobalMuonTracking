...
void MUONMatcher::DLRegression(std::string input_name, std::string trainingfile, std::string trainingstr)
{
  ...
  std::string MLMethodType = gSystem->Getenv("ML_METHOD");
  TMVA::Factory* factory = new TMVA::Factory(MLAnalysisType + "_" + MLMethodType, outputFile,
  ...
  if (MLMethodType == "DNN") {
    ...
    MLMethodType = "BDT";
  } else if (MLMethodType == "FDA_GA" or MLMethodType == "FDA_GAMT" or MLMethodType == "FDA_MC" or MLMethodType == "FDA_MT") {
    MLMethodType = "FDA";
  }
  ...
  factory->BookMethod(dataloader, TMVA::Types::Instance().GetMethodType(MLMethodType), methodname, trainingstr);
  // --------------------------------------------------------------------------------------------------
